...
use hub75_embassy::{Hub75Display, Hub75Pins, Brightness};
use panic_halt as _;
...
static DISPLAY: SharedDisplay = Mutex::new(Hub75Display::new(unsafe { core::mem::zeroed() }).unwrap());
    ...
    loop {
        {
            ...
            Circle::new(Point::new(32 - radius as i32 / 2, 16 - radius as i32 / 2), radius)
                .into_styled(
                    PrimitiveStyleBuilder::new()
